...
def make_random(M, num_cols, num_rows):
...
def draw(M, num_rows, num_cols, image):
...
def main():
    ...
    make_random(M, num_cols, num_rows)
    draw(M, num_cols, num_rows, image)
